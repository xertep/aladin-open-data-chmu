...
if layer == "Vítr" and "wind_speed_path" in st.session_state:
    ...
    for idx, t in enumerate(all_times):
        ...
        legend_box = mpatches.FancyBboxPatch(
            (0.81, 0.67),   # x, y (bottom-left in axes coords)
        ...
        k2 = ax.quiverkey(q, 0.9, 0.90, 5, "5 m/s", labelpos="E")
        k3 = ax.quiverkey(q, 0.9, 0.85, 7, "7 m/s", labelpos="E")
        k4 = ax.quiverkey(q, 0.9, 0.80, 10, "10 m/s", labelpos="E")
        k5 = ax.quiverkey(q, 0.9, 0.42, 13, "13 m/s", labelpos="E")
